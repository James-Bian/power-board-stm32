...
int main(void)
{
  ...
  MX_TIM3_Init();
	...
	LOG_Always("HAL Version:%08x \r\n", HAL_GetHalVersion()); 
	LOG_Always("REVID:%08x \r\n", HAL_GetREVID());
	LOG_Always("DEVID:%08x \r\n", HAL_GetDEVID());
	LOG_Always("Wellcome using power board!\r\n");
